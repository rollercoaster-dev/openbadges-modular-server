...
// Define the structure for the user context and auth variables (mirroring the implementation)
...
describe('Authentication Middleware', () => {
  ...
  test('should authenticate with a valid adapter', async () => {
    ...
    const variables: Record<string, HonoContextVariables[keyof HonoContextVariables]> = {};
    ...
    const mockContext = {
      ...
      header: (name: string) => request.headers.get(name),
      set: <K extends keyof HonoContextVariables>(key: K, value: HonoContextVariables[K]) => {
        variables[key] = value as HonoContextVariables[keyof HonoContextVariables];
      },
      get: (key: string) => {
