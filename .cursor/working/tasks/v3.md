...
- [ ] Task 3.2.7: Integrate the Schema Validation Service into the Assertion creation and update flow to perform validation.
  **PLAN**:
  - Update Assertion entity to include credentialSchema property
  - Modify assertion creation/update controllers to call schema validation
  - Update validation middleware to include schema validation
  - Add credentialSchema to Zod schemas
  - Files to modify:
    ...
    - `src/api/controllers/assertion.controller.ts`

- [ ] Task 3.2.8: Add unit tests for the schema validation logic using various valid and invalid schemas/credentials.
  **PLAN**:
  - Create test schemas (valid/invalid)
  - Test schema fetching and caching
  - Test credential validation success/failure cases
  - Test error handling for network failures
  - Files to create:
    - `tests/core/schema-validation.service.test.ts`
...
- [ ] Task 3.2.9: Add API tests to verify that invalid credentials are rejected with appropriate error messages due to schema validation failures.
  **PLAN**:
  - Add API tests for assertion creation with invalid credentialSchema
  - Test proper error responses and status codes
  - Verify error message clarity and usefulness
  - Files to create: `tests/api/assertion-schema-validation.test.ts`
